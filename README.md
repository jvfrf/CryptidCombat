...
<head>
    ...
    <title>Cryptid Combat - Dev Checklist</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
            background: linear-gradient(135deg, #21222c 0%, #2f313f 100%);
            color: #d1d1d1;
            min-height: 100vh;
            padding: 20px;
        }
        ...
        .header {
            ...
            margin-bottom: 20px;
            padding: 20px;
            background: rgba(47, 49, 63, 0.5);
            border-radius: 15px;
            border: 1px solid rgba(169, 152, 212, 0.2);
        }
        .header h1 {
            font-size: 2.5rem;
            background: linear-gradient(45deg, #a998d4, #d3c5f0);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            background-clip: text;
            margin-bottom: 10px;
            text-shadow: 0 0 10px rgba(169, 152, 212, 0.1);
        }
        .update-logger {
        ...
        .update-logger button {
            padding: 8px 15px; border: 1px solid #a998d4; border-radius: 5px;
            background: transparent; color: #a998d4; font-weight: bold; cursor: pointer;
            transition: all 0.2s ease;
        }
        .update-logger button:hover { background: rgba(169, 152, 212, 0.2); }
        #last-updated { font-size: 0.9em; color: #f0e68c; flex-basis: 100%; margin-top: 10px; }
        .sync-container {
            text-align: center; margin-bottom: 30px; padding: 20px;
            background: rgba(47, 49, 63, 0.5); border-radius: 15px;
            border: 1px solid rgba(169, 152, 212, 0.2);
        }
        .sync-container h2 { margin-bottom: 15px; color: #f0e68c; }
        .sync-controls { display: flex; justify-content: center; gap: 30px; align-items: center; flex-wrap: wrap; }
        .sync-box { text-align: center; }
        .sync-box button, .sync-box input {
             padding: 10px 20px; border: none; border-radius: 5px;
             font-weight: bold; cursor: pointer; transition: all 0.2s ease;
        }
        #export-button { background-color: #a998d4; color: #21222c; }
        #export-button:hover { background-color: #d3c5f0; }
        #import-button { background-color: #f0e68c; color: #21222c; }
        #import-button:hover { background-color: #fffac8; }
        
        .developers { display: grid; grid-template-columns: 1fr 1fr; gap: 30px; margin-bottom: 40px; }
        .dev-section {
        ...
        .priority-high { border-left-color: #e55353; }
        ...
        <div class="developers">
            <div class="dev-section">
                ...
                <div class="task-category"><div class="category-header">Retopology & UVs</div>
                    ...
                    <div class="task priority-low" data-dev="mindsigh"><div class="task-checkbox"></div><div class="task-text">Retopologize & UV unwrap Dragon-Knight</div></div>
                ...
                <div class="task-category"><div class="category-header">UI & Icons</div>
                 ...
                 <div class="task-category"><div class="category-header">VFX Concepts</div>
                    ...
                    <div class="task priority-low" data-dev="mindsigh"><div class="task-checkbox"></div><div class="task-text">Design Burn status effect VFX</div></div>
            ...
            <div class="dev-section">
                ...
                <div class="task-category"><div class="category-header">AI & Core Mechanics</div>
                    ...
                    <div class="task priority-medium" data-dev="hasty"><div class="task-checkbox"></div><div class="task-text">Code basic AI behavior for Tank & Support classes</div></div>
...
<details style="margin-top: 60px; background: rgba(47, 49, 63, 0.5); padding: 20px; border-radius: 15px; border: 1px solid rgba(169, 152, 212, 0.2); color: #d1d1d1;">
  <summary style="font-size: 1.3rem; color: #f0e68c; cursor: pointer;">📄 View Full Game Design Document (Markdown)</summary>
  <pre style="white-space: pre-wrap; margin-top: 15px; font-size: 0.9rem; line-height: 1.5; color: #ccc;">
Cryptid Combat - Auto Battler Game Design Document

🎮 Core Concept  
Genre: 1v1 Auto Battler  
Style: Fantasy-Cartoon (Blizzard/OG Warcraft inspired)  
Platform: PC (Windows/Linux compatible)  
Development: Unreal Engine 5.6
Timeline: 2 Week Game Jam  

⚔️ Game Flow  
- Character Selection (15s): Choose cryptid  
- Prep Phase (20s): Spend 6 points to upgrade 3 abilities  
- Auto Battle Phase (30-45s): AI combat  
- Victory Screen (10s): See results and return to select  

👹 Cryptid Roster (6 Total)  
Tank - Yeti  
Support - Forest Sprite  
Berserker - Dragon-Knight  
Assassin - Mothman  
Ranged - Jersey Devil  
Tech - Space Alien  
(Each has 3 Leveled  abilities with scaling bonuses)

🏟️ Arena Environments  
Ice Cavern: Freezing Aura + random ice spike damage  
Haunted Forest: Random debuffs + buff/debuff mushrooms  
Alien Lab: Ability boost + random battlefield tech effects  

🎯 Auto Battler Mechanics  
- Stats: Attack, Defense, Speed (1-10), HP (100-200)  
- AI Priority Logic  
- Victory: First to 0 HP  
- Best of 3 with reallocation between rounds  

🎨 Art Direction  
- Fantasy-cartoon sculpts  
- Mystical-tech UI theme  
- Readable silhouettes + polished VFX  

Team: Mindsigh13 (Art) + hasty_wasty (Programming)  
